...
exports.returnBook = async function(req, res, con, secret) {
    ...
    var lendmessage = `${borrowname} has requested you to take back your book ${book.Bookname}. For further actions visit your Quickbooks`;
    var borrowmessage = `You have requested ${lendname} to take back the book ${book.Bookname}`;
